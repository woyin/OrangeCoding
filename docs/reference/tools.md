...
OrangeCoding 的工具系统基于 `orangecoding-tools` crate 实现，提供了一套统一的工具接口。所有工具均实现以下核心 trait：
...
**源文件**: `crates/orangecoding-tools/src/edit_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/bash_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/grep_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/find_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/browser_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/web_search_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/fetch_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/lsp_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/ast_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/python_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/notebook_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/ask_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/calc_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/ssh_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/todo_tool.rs`
...
**源文件**: `crates/orangecoding-tools/src/task_tool.rs`
