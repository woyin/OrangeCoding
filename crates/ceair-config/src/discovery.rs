...
//! 支持 CEAIR 原生配置、Claude Code、Codex、Gemini 等工具的配置发现。
//! 按优先级排序，高优先级的配置优先生效。
...
mod tests {
    ...
    fn test_provider_dir_names() {
        assert_eq!(ConfigProvider::Native.dir_name(), ".ceair");
    ...
    fn test_config_dirs_ordering() {
        ...
        // 创建项目级和用户级配置目录
        create_dir(&project, ".ceair");
        create_dir(&project, ".claude");
        create_dir(&home, ".ceair");
        ...
        assert_eq!(dirs[0].0, ConfigProvider::Native);  // 项目级 .ceair
        assert_eq!(dirs[1].0, ConfigProvider::Native);  // 用户级 .ceair
    ...
    fn test_discover_rules_native() {
        ...
        // 创建 .ceair/AGENTS.md
        create_file(&project, ".ceair/AGENTS.md", "# 规则文件");
    ...
    fn test_discover_skills() {
        ...
        // 创建技能包目录结构
        create_file(&project, ".ceair/skills/code-review/SKILL.md", "# 代码审查技能");
        create_file(&project, ".ceair/skills/testing/SKILL.md", "# 测试技能");
    ...
    fn test_discover_commands() {
        ...
        // 创建命令目录
        create_file(&project, ".ceair/commands/deploy.md", "# 部署命令");
        create_file(&project, ".ceair/commands/lint.md", "# 代码检查命令");
    ...
    fn test_dedup_by_name() {
        ...
        create_file(&project, ".ceair/AGENTS.md", "# Native 规则");
    ...
    fn test_disabled_provider_skipped() {
        ...
        create_file(&project, ".ceair/AGENTS.md", "# Native");
    ...
    fn test_disabled_extension_skipped() {
        ...
        create_file(&project, ".ceair/skills/review/SKILL.md", "# 审查");
        create_file(&project, ".ceair/skills/deploy/SKILL.md", "# 部署");
    ...
    fn test_find_config_file_priority() {
        ...
        create_file(&project, ".ceair/mcp.json", r#"{"native": true}"#);
    ...
    fn test_discover_mcp_configs() {
        ...
        create_file(&project, ".ceair/mcp.json", r#"{"servers": []}"#);
        create_file(&home, ".ceair/mcp.json", r#"{"servers": ["global"]}"#);
    ...
    fn test_discover_all_aggregation() {
        ...
        // 创建多种类型的配置
        create_file(&project, ".ceair/AGENTS.md", "# 规则");
        create_file(&project, ".ceair/mcp.json", "{}");
        create_file(&project, ".ceair/skills/test-skill/SKILL.md", "# 技能");
        create_file(&project, ".ceair/commands/build.md", "# 构建");
