...
impl ConfigLayer {
    ...
    ///
    /// 将结构体扁平化为点分隔的键值对。
    pub fn from_config(source: ConfigSource, config: &CeairConfig) -> ceair_core::Result<Self> {
...
impl LayeredConfig {
    ...
    pub fn get_effective_config(&self) -> ceair_core::Result<CeairConfig> {
